...
vec4 PointLight()
{
	...
	return texture(diffuse0, outTexCoord) * lightColor * (diffuse * intensity + ambientStrength + specular * intensity);
}
...
vec4 DirectionLight()
{
	...
	return texture(diffuse0, outTexCoord) * lightColor * (diffuse + ambientStrength + specular);
}
